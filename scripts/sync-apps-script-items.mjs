...
import {ITEM_SCHEMA,oldCodes,normalizeItemSave} from '../src/item-save.mjs';
...
const block=[start,'// Generated from src/catalog.mjs. Run node scripts/sync-apps-script-items.mjs.',
 ...
 'const ITEM_SCHEMA = '+ITEM_SCHEMA+';','const oldCodes = '+JSON.stringify(oldCodes)+';',normalizeItemSave.toString(),
