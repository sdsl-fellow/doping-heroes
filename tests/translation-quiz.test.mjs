...
const source=fs.readFileSync('google-apps-script/Code_v20.gs','utf8');
...
test('bank contains 9 terms / 21 sentences with unique IDs and source pages',()=>{
 ...
 assert.equal(fs.readFileSync('google-apps-script/Code_v22.gs','utf8'),fs.readFileSync('google-apps-script/Code.gs','utf8'));
});
