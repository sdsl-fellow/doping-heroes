...
export const equipment=[...catalog,...['outfit','shoes','hat','weapon','accessory'].map(slot=>({slot,id:'none',name:'없음',quest:-1,code:'',price:null,base:'none',color:'#ffffff',row:0,col:0,icon:-1}))];
