...
export type TranslationRound={storageMode?:'student-question';id:string;expiresAt:number;questions:{id:string;kind:'term'|'sentence';english:string;options:{id:string;text:string}[]}[];results:Record<string,TranslationResult>};
