...
const base='./lpc/';
export function layers(c:Character){if(c.gender==='neutral')return [{path:`animals/${c.species}/walk.png`,color:c.hairColor},...(c.accessory==='headband'?[{path:'hat/headband/thick/adult/walk.png',color:'#d87569'}]:[]),...(c.hat!=='none'?[{path:'hat/cloth/leather_cap/adult/walk.png',color:c.hat==='trailcap'?'#b9dbe4':'#6b8c56'}]:[])];const clothes=c.outfit==='cardigan'?'longsleeve/longsleeve2_cardigan':c.outfit==='longsleeve'?'longsleeve/longsleeve':'shortsleeve/tshirt';return [
