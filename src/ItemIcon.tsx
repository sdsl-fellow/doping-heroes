...
export function ItemIcon({id}:{id:string}){
 ...
 return <span className="catalog-icon" aria-hidden="true"><img src={`./item-icons/${item.code}.png`} alt="" style={{width:'100%',height:'100%',objectFit:'contain',filter:item.id==='C01'?'grayscale(1) brightness(1.08)':undefined}}/></span>;
}
