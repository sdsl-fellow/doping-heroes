...
const RELEASE_LABEL = 'v19-silicon-questions';
...
// Included in Code_v19.gs. Do not install alongside the complete bundle.
...
function learningSheet_(name){
 ...
 if(!id)throw apiError_('CONTENT_SETUP','관리자가 Code_v19.gs의 setupLearningContentV16을 실행해주세요.');
 const sheet=SpreadsheetApp.openById(id).getSheetByName(name);
